    ...
    <header className="sticky top-0 z-50 backdrop-blur-md bg-zinc-950/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        <Link href="/" className="block group">
          <h1 className="font-serif text-2xl font-bold tracking-tight bg-gradient-to-r from-amber-200 via-amber-300 to-amber-200 bg-clip-text text-transparent drop-shadow-[0_0_12px_rgba(251,191,36,0.15)]">
            linGhost
          </h1>
        </Link>
        ...
        <div className="flex items-center gap-1 sm:gap-4">
          <Link
            href="/timeline"
            className="flex items-center gap-1.5 text-sm text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 px-2 py-1.5 sm:px-3 rounded-md transition-all"
          >
            <svg
              className="w-4 h-4"
              fill="none"
